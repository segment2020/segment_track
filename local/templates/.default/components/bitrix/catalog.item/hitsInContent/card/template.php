...
if (!empty($item['~PREVIEW_PICTURE']))
	$fileImg = CFile::ResizeImageGet($item['PREVIEW_PICTURE']["ID"], array('width'=>300, 'height'=>120), BX_RESIZE_IMAGE_PROPORTIONAL, true);
else
...
<div class="col-sm-4 col-xs-6 cell-12-xs content-margin">
	<div class="line">
		<a href="<? echo $item['DETAIL_PAGE_URL']; ?>">
			<div class="centerimg">
				<img src="<? echo $fileImg['src']; ?>" />
			</div>
			<div class="descr descrHits">
				<div class="price"><? echo $price['PRICE']; ?><span>руб.<span></div>
				<div class="titleblock"><? echo $productTitle; ?></div>
			</div>
		</a>
	</div>
</div>
