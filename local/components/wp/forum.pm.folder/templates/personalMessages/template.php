...
for ($ii = 1; $ii <= $arResult["FORUM_SystemFolder"]; $ii++):
	...
	switch ($ii)
	{
		case 1:
		{
			$folder = explode('/', $arResult["SYSTEM_FOLDER"][$ii]["URL"]["FOLDER"]);
			$folder = 'inbox/' . $folder[1];
			break;
		}
...
?>
				...
				?>
						...
						*/
						?>
						<span>(<?=$arResult["SYSTEM_FOLDER"][$ii]["CNT_NEW"]?>)</span>
				<?
				endif;
				?>
					</td>
