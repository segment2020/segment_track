...
foreach($arResult["ITEMS"] as $arItem)
{
	...
	if ($arItem["PREVIEW_PICTURE"]["SRC"])
		...
		$file['src'] = '';
?>
	<div class="eventitem clearfix" id='<? echo $arItem['ID']; ?>'>
...
<div class="block-shadow content-margin showmoreblock text-center" id='showmoreblock' data='1'>
	<span>+</span>Показать еще 10 событий
</div>
<div class="block-shadow content-margin showmoreblock text-center" id='preloaderBlock' style='display: none;'>
	Загрузка
</div>
