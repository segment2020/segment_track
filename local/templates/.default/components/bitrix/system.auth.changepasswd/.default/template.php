		...
		<div class="col-xs-12">
			...
			<p><?=GetMessage("AUTH_CHANGE_PASSWORD")?></p>
				<form method="post" action="<?=$arResult["AUTH_FORM"]?>" name="bform">
					...
					<div class="form-group">
						<label class="control-label mainlabel"><?=GetMessage("AUTH_CHECKWORD")?>*</label>
						<input class="form-control" type="text" name="USER_CHECKWORD" maxlength="50" value="<?=$arResult["USER_CHECKWORD"]?>" class="bx-auth-input" />
					</div>

					<div class="form-group">
						<label class="control-label mainlabel"><?=GetMessage("AUTH_NEW_PASSWORD_REQ")?>*</label>
					...
					<div class="form-group">
						<label class="control-label mainlabel"><?=GetMessage("AUTH_NEW_PASSWORD_CONFIRM")?>*</label>
					...
					<div class="form-group btnblock">
						<button class="btn btn-blue-full minbr" name="change_pwd"><?=GetMessage("AUTH_CHANGE")?><i class="icon-icons_main-10"></i></button>
					</div>
				</form>
