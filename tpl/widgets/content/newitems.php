...
$APPLICATION->IncludeComponent("bitrix:news.list", "newListInDetail", Array(
	"COMPONENT_TEMPLATE" => "newListInDetail",
		"IBLOCK_TYPE" => "new",	// Тип информационного блока (используется только для проверки)
