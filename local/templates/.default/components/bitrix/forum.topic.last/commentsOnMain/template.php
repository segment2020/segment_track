...
?>
	<div class="newsbitem clearfix">
		<div class="commenttitlelink">
			<a href="<?=$res["read"]?>" class="forum-title<?=($res["SORT"] == 100 ? " pinned" : "")?>"><?=$res["TITLE"]?></a>
		</div>
		<div class="infotvc">
			<span class="infotime"><?=$res['MESSAGE']['POST_DATE']?></span>
			<span class="infoview"><i class="icon-icons_main-05"></i><?=$res["VIEWS"]?></span>
			<span class="infocomment"><i class="icon-icons_main-04"></i>0</span>
		</div>
		<div class="commentdescr nodisp1320">
			 Обращайтесь к нам! Нам всегда есть чем..
		</div>
