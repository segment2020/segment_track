				...
				<?endif?>
					...
					<form name="form_auth" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
						...
						<div class="form-group">
							<label class="control-label mainlabel"><?=GetMessage("AUTH_LOGIN")?></label>
							<input class="form-control" type="text" name="USER_LOGIN" maxlength="255" value="<?=$arResult["LAST_LOGIN"]?>" />
						</div>
						<div class="form-group">
							<label class="control-label mainlabel"><?=GetMessage("AUTH_PASSWORD")?></label>
						...
						<?if($arResult["CAPTCHA_CODE"]):?>
							...
							<div class="form-group">
								<label class="control-label mainlabel"><?echo GetMessage("AUTH_CAPTCHA_PROMT")?>:</label>
								<input class="form-control" type="text" name="captcha_word" maxlength="50" value="" size="15" />
							</div>
						<?endif;?>						
						<?if ($arResult["STORE_PASSWORD"] == "Y"):?>
							<div class="form-group">
								<div class="mycheckbox"><label for="USER_REMEMBER"><input type="checkbox" id="USER_REMEMBER" name="USER_REMEMBER" value="Y" />&nbsp;<?=GetMessage("AUTH_REMEMBER_ME")?></label></div>
							</div>
						<?endif?>				
						<div class="form-group btnblock">
							<button class="btn btn-blue-full minbr" name="Login"><?=GetMessage("AUTH_AUTHORIZE")?><i class="icon-icons_main-10"></i></button>
						</div>						
