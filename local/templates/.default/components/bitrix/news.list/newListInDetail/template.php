...
<div class="block-default block-shadow content-margin compnewsblock in nobgimg">
	<div class="block-title clearfix">
		...
		<a class="floatright" href="<? echo $arResult["SECTION_PAGE_URL"]; ?>?companyid=<? echo $arResult["ITEMS"][0]['PROPERTIES']['companyId']['VALUE']; ?>">Все новинки<i class="icon-icons_main-10"></i></a>
	</div>
	<div class="row">
	<?
	foreach($arResult["ITEMS"] as $arItem)
	{
		...
		if ($fileNum)
			$file = CFile::ResizeImageGet($fileNum, array('width'=>60, 'height'=>60), BX_RESIZE_IMAGE_PROPORTIONAL, true);
