	...
	<div class="newblockitem clearfix">
		<a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>">
			<?if ($arItem["PREVIEW_PICTURE"]["ID"])
			{
				...
				echo '<div class="img floatleft nodisp1320"><img src="'.$file['src'].'" /></div>';
			} else { ?>							
				<div class="img floatleft nodisp1320"><img src="/tpl/images/60х60.jpg" /></div>
			<? } ?>
			<div class="descr nomarginleft1320">
				<div><? echo $productTitle; ?></div>
				<span class="price"><? echo $arItem['MIN_PRICE']['PRINT_VALUE']; ?></span>
			</div>
		</a>
	</div>
<?
