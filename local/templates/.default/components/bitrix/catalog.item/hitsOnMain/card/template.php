...
<a href="<? echo $item['DETAIL_PAGE_URL']; ?>" class="hits_item text-center">
	<div style="background-image: url('<? echo $fileImg['src']; ?>');" class="hits_image"></div>
	<div class="hits_title">
		<? echo $productTitle; ?>
	</div>
	<div class="hits_preview">
		<? echo strip_tags($item['DISPLAY_PROPERTIES']['brand']['DISPLAY_VALUE']); ?>
	</div>
	<div class="hits_price"><? echo $price['PRICE']; ?><span>руб.</span></div>
</a>
