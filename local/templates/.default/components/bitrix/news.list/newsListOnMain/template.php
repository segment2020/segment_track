...
//pre($arResult);
?>
<div class="block-title clearfix"><a class="notitlestyle" href="<? echo $arResult['SECTION_PAGE_URL']; ?>"><? echo $arResult['NAME']; ?></a></div>
<?
...
?>
			...
			<div class="newsbimg floatleft nodisp1320"><img src="<? echo $file['src']; ?>" width='60px'></div>
			<div class="newsbtext nomarginleft1320 <? echo $class; ?>">
