...
{
	$companyId = $arResult['ITEMS'][0]['PROPERTIES']['companyId']['VALUE'];
?>
<div class="block-default block-shadow content-margin innernewblock nobgimg">
	<div class="block-title clearfix">
		<i class="icon-icons_main-06"></i>
		<span>
			<a class="bigRed" href="/hits/?companyId=<? echo $companyId; ?>">Хиты</a>
		</span>
		<a class="floatright" href="/hits/?companyId=<? echo $companyId; ?>">Все хиты<i class="icon-icons_main-10"></i></a>
	</div>
