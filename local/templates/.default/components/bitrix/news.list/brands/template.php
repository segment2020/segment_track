...
<div class="block-title clearfix">
	<a class="notitlestyle" href="<? echo $arResult['SECTION_PAGE_URL']; ?>"><? echo $arResult['NAME']; ?></a><a class="floatright" href="<? echo $arResult['SECTION_PAGE_URL']; ?>">Все бренды<i class="icon-icons_main-10"></i></a>
</div>
<div class="row">
<?
	...
	<div class="col-xs-6">
		<div class="tableblockitem nobmarrgin">
			<a href="<? echo $arItem["DETAIL_PAGE_URL"]; ?>">
				...
				<div class="textblock nomarginleft1320 mainBrandsBlock">
					<div class="firmblock">
						Собственник <span><? echo $companyName; ?></span>
					</div>
