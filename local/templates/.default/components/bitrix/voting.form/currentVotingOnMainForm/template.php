...
?>
<div class=''>
<div class="interviewtitle" style='font-weight: bold;'><?=$arQuestion["QUESTION"]?></div>
<div class="interviewblock-scroll">
	<form action="<? if ($arParams['VOTING_URL']) { echo $arParams['VOTING_URL']; } else { echo POST_FORM_ACTION_URI; } ?>" method="post" class="vote-form">
...
?>
					<div class="radio">
						<input class="vote_change" type="radio" <?=$value?> name="vote_radio_<?=$arAnswer["QUESTION_ID"]?>"
...
<?
				...
				case 1://checkbox?>
					<span class="vote-answer-item vote-answer-item-checkbox">
						<input class="vote_change" <?=$value?> type="checkbox" name="vote_checkbox_<?=$arAnswer["QUESTION_ID"]?>[]" value="<?=$arAnswer["ID"]?>" <?
...
<?					break;
				...
				case 2://dropdown?>
					<span class="vote_change" class="vote-answer-item vote-answer-item-dropdown">
...
<?					break;
				...
				case 3://multiselect?>
					<span class="vote-answer-item vote-answer-item-multiselect">
						<select class="vote_change" name="vote_multiselect_<?=$arAnswer["QUESTION_ID"]?>[]" <?=$arAnswer["~FIELD_PARAM"]?> multiple="multiple">
				...
				<?case 4://text field?>
					<span class="vote-answer-item vote-answer-item-textfield">
						...
						<input class="vote_change" type="text" name="vote_field_<?=$arAnswer["ID"]?>" id="vote_field_<?=$arAnswer["ID"]?>" <?
				...
				<?case 5://memo?>
					<span class="vote-answer-item vote-answer-item-memo">
						...
						<textarea class="vote_change" name="vote_memo_<?=$arAnswer["ID"]?>" id="vote_memo_<?=$arAnswer["ID"]?>" <?
...
?>
		<? /* ?><input type="submit" name="vote" value="<?=GetMessage("VOTE_SUBMIT_BUTTON")?>" class="btn btn-blue-full minbr vote_send" /><? */ ?>
	</form>
</div>
</div>
