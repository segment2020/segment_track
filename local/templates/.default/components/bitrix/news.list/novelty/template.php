...
/*
	...
	// {
		...
		if ($fileNum)
			$file = CFile::ResizeImageGet($fileNum, array('width'=>60, 'height'=>40), BX_RESIZE_IMAGE_PROPORTIONAL, true);
	// }
	if (null === $file && $arItem["PREVIEW_PICTURE"]["SRC"])
		$file = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"]["ID"], array('width'=>60, 'height'=>40), BX_RESIZE_IMAGE_PROPORTIONAL, true);
	...
	// pre($arItem['PROPERTIES']['showLogo']); 
		...
		elseif (!empty($arItem['PROPERTIES']['companyId']['VALUE']))
		{
			...
			if (!empty($arFields['PREVIEW_PICTURE']))
				$file = CFile::ResizeImageGet($arFields['PREVIEW_PICTURE'], array('width'=>60, 'height'=>40), BX_RESIZE_IMAGE_PROPORTIONAL, true);
		} 
...
?>
	...
	<div class="newblockitem clearfix">
		<a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>">
			<div class="img floatleft nodisp1320"><img src="<? echo $file['src']; ?>" width='55px'></div>
			<div class="descr nomarginleft1320 <? echo $class; ?>">
