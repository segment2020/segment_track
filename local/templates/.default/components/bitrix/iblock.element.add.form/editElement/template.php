...
if (!empty($arResult["ERRORS"]))
{
	...
	header('Location: /personal/company/news/edit/?errorStr=' . $errorStr . '&ELEMENT_ID=' . $arParams['ID'] . '&iBlockId=' . $arParams['IBLOCK_ID']);
	exit();
}
...
if (strlen($arResult["MESSAGE"]) > 0)
{
	...
	{
		header('Location: /personal/company/news/edit/?ELEMENT_ID=' . $arParams['ID'] . '&iBlockId=' . $arParams['IBLOCK_ID'] . '&msg=' . $arResult["MESSAGE"]);
		exit();
	}
	elseif ($arResult["MESSAGE"] === 'Элемент успешно добавлен')
	{
		header('Location: /personal/company/news/?iBlockId=' . $arParams['IBLOCK_ID']);
		exit();
	}
}
?>
