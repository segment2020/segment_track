...
<div class="block-default block-shadow content-margin fliteralphabetblock clearfix show_rus">
	...
	<div class="fliteralphabetshowall floatright">
		<a href="/brands/list/"><i class="icon-icons_main-05"></i>Показать все</a>
	</div>
...
{
	// if (!preg_match('/[а-я]/i', $arItem['~NAME']))
		// continue;
...
<?
	...
	elseif (!empty($arItem['DISPLAY_PROPERTIES']['companyId']['DISPLAY_VALUE']))
	{
		// $companyName = strip_tags($arItem['DISPLAY_PROPERTIES']['companyId']['DISPLAY_VALUE']);
		$companyName = 'не указан';
	}
?>
			<div class="newsbfirm">Собственник бренда: <? echo $companyName; ?></div>
		</div>
