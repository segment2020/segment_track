...
foreach ($arResult["USERS"] as $user) {
	$avatar = (!empty($user["~AVATAR"]["HTML"]))? $user["~AVATAR"]["HTML"]: '<img src="' . EMPTY_LOGO_AVATAR_PATH . '" />';
?>
	<div class="block-default in block-shadow content-margin corpnewsblock" id='userBlock<? echo $user['ID']; ?>'>
		<div class="newsbitem clearfix">
			...
			<div class="newsbtext">
				...
				<div class="infotvc">
					<span class="infotime">Зарегистрирован: <? echo $user['DATE_REG']; ?></span>
					<span class="infoview">Последний визит: <? echo $user['LAST_VISIT']; ?></span>
				</div>
			</div>
		</div>
	</div>
...
<div class="forum-block-container">
	<div class="forum-block-outer">
		<div class="forum-block-inner">
			...
			<thead>
				<tr>
					<th class="forum-first-column forum-column-username"><span><?=GetMessage("FLU_HEAD_NAME")?></span>
					<?
					//&nbsp;<br/><?=$arResult["SortingEx"]["SHOW_ABC"]?>
					?></th>
