...
$res = CIBlockElement::GetProperty($arParams['IBLOCK_ID'], $ElementID, array(), array('ID' => PROPERTY_ID_ADD_MATERIAL_IN_STOCK));
...
<?$APPLICATION->IncludeFile('/tpl/widgets/content/newsitems.php', array('iBlockId' => IBLOCK_ID_NEWS_COMPANY, 'company_id'=> $resID['PROPERTY_COMPANYID_VALUE'], 'curent_news_id' => $resID['ID']), array());?>
