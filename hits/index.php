...
{
	global $arrFilter;
	$arrFilter['PROPERTY_companyId'] = $_GET['companyId'];
	$filter = true;
}
...
{
	$elementsNum = $_POST['elemNum'];
	$_SESSION['elemNumHits'] = $elementsNum;
}
elseif (isset($_SESSION['elemNumHits']) && !empty($_SESSION['elemNumHits']))
{
	$elementsNum = $_SESSION['elemNumHits'];
}
