...
$res = CIBlockElement::GetProperty($arParams['IBLOCK_ID'], $ElementID, array(), array('ID' => PROPERTY_ID_ADD_MATERIAL_IN_VIEWPOINT));
...
?>
	...
	<?
	/*
	<div class="block-default block-shadow content-margin commentblock">
		<div class="block-title clearfix"><span>Обсудить с другими читателями</span></div>
		<div class="clearfix">
			<div class="commentblockimg floatleft">
				<img src="tpl/images/ava.png">
			</div>
			<div class="commentblocktext">
				<div class="commentblockname">Петров Станислав</div>
				<div class="commentblockdate">14 Сен 2016 09:55</div>
				<div class="commentblockdescr">О том, как предприятие инвалидов, производившее тетради, нашло себя на рынке упаковки, изданию «БИЗНЕС Online» рассказал генеральный директор ООО «Учебно-производственное предприятие «Картонажно-полиграфические изделия» (КПИ) Айрат Ибрагимов.</div>
				<div class="commentblockanswer">
					<a href="#">Ответить</a>
				</div>
			</div>
		</div>
	...
	<div class="block-default block-shadow content-margin addcommentblock">
		<div class="block-title clearfix"><span>Оставить комментарий</span><span class="links floatright"><a href="#">Войти</a>  /  <a href="#">Зарегистрироваться</a>  /  <a href="#">Правила обсуждения</a></span></div>
		<form>
			...
			<div class="addcommentbuttons clearfix">
				<div class="addfilesblock clearfix floatleft">
					<div class="addfilestitle floatleft">Прикрепить</div>
				...
				<div class="floatright">
					<div class="btn btn-blue-full">
						Оставить комментарий<i class="icon-icons_main-10"></i>
					</div>
				</div>
			</div>
		</form>
