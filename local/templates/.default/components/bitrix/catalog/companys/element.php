...
if ($resID['ID'] && $resID['IBLOCK_ID'])
	viewsinc($resID['ID'], $resID['IBLOCK_ID'], $resID['ID'], $resID['DATE_CREATE']);
...
$arSelect = Array("ID");
$arFilter = Array("IBLOCK_ID" => IBLOCK_ID_COMPANY, "ACTIVE"=>"Y", "CODE" => $arResult['VARIABLES']['ELEMENT_CODE']);
$resID = CIBlockElement::GetList(Array(), $arFilter, false, Array(), $arSelect)->GetNext();
// pre($resID);
?>
<?$APPLICATION->IncludeFile('/tpl/widgets/content/newsitems.php', array('iBlockId' => IBLOCK_ID_NEWS_COMPANY, 'company_id'=> $resID['ID'], 'curent_news_id' => $resID['ID']), array());?>
<?$APPLICATION->IncludeFile('/tpl/widgets/content/photo.php', array('company_id'=> $resID['ID']), array());?>
<?$APPLICATION->IncludeFile('/tpl/widgets/content/newitems.php', array('company_id'=> $resID['ID']), array());?>
<?$APPLICATION->IncludeFile('/tpl/widgets/content/productsreviews.php', array('company_id'=> $resID['ID']), array());?>
<?$APPLICATION->IncludeFile('/tpl/widgets/content/promotions.php', array('company_id'=> $resID['ID']), array());?>
<?$APPLICATION->IncludeFile('/tpl/widgets/content/video.php', array('company_id'=> $resID['ID']), array());?>
<?$APPLICATION->IncludeFile('/tpl/widgets/content/hits.php', array('company_id'=> $resID['ID']), array());?>