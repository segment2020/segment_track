...
?>
		...
		<div class="form-group">
			<label class="control-label mainlabel" for="lk_input3">E-mail</label>
			<input type="text" class="form-control" id="lk_input3" name="REGISTER[LOGIN]" value="<?=$arResult["USER_EMAIL"]?>">
		</div>
		<div class="form-group">
			<label class="control-label mainlabel" for="lk_input4">Пароль</label>
			<input type="password" class="form-control" id="lk_input4" name="REGISTER[PASSWORD]" value="<?=$arResult["USER_PASSWORD"]?>">
		</div>
		<div class="form-group">
			<label class="control-label mainlabel" for="lk_input5">Введите пароль повторно</label>
			<input type="password" class="form-control" id="lk_input5" name="REGISTER[CONFIRM_PASSWORD]" value="<?=$arResult["USER_CONFIRM_PASSWORD"]?>">
		</div>
		<div class="btnblock text-center">
			<button class="btn btn-blue-full minbr" name="register_submit_button">Зарегистрироваться<i class="icon-icons_main-10"></i></button>
		</div>
	</form>
