...
<? if ($showBottomPager) { ?>
	<div class="paginationblock clearfix" data-pagination-num="<?=$navParams['NavNum']?>">
		...
		<?$APPLICATION->IncludeFile('/tpl/include_area/elementsNumberForHits.php', array('action' => $arParams['CURRENT_BASE_PAGE'], 'elemNum' => $arParams['PAGE_ELEMENT_COUNT']), array());?>
	</div>
<?  } ?>
