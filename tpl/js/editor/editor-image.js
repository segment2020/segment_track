                ...
                (t.exports = (function (t) {
                            ...
                            d =
                                ((i = function (t) {
                                    return new Promise(function (e, n) {
                                        (t = u(t)), (t = c(t)).beforeSend && t.beforeSend();
                                        ...
                                        o.upload.addEventListener(
                                            ...
                                            (o.onreadystatechange = function () {
                                                if (4 === o.readyState) {
                                                    ...
                                                    var r = f.parseHeaders(o.getAllResponseHeaders()),
                                                        i = { body: t, code: o.status, headers: r };
                                                    l(o.status) ? e(i) : n(i);
                                                }
                                            }),
                                            o.send(t.data);
                                ...
                                (u = function () {
                                    ...
                                    if (((t.headers = t.headers || {}), t.type && ("string" != typeof t.type || !Object.values(r).includes(t.type)))) throw new Error("`type` must be taken from module's «contentType» library");
                                ...
                                (c = function (t) {
                                    switch (t.method) {
                                        ...
                                        case "UPDATE":
                                            ...
                                            (f.isFormData(t.data) || f.isFormElement(t.data)) && (n = r.FORM), (t.data = s(t.data, n)), n !== d.contentType.FORM && (t.headers["content-type"] = n);
                                    }
                                    return t;
                                }),
                                (s = function () {
                                ...
                                {
                                    contentType: (r = { URLENCODED: "application/x-www-form-urlencoded; charset=utf-8", FORM: "multipart/form-data", JSON: "application/json; charset=utf-8" }),
                                    request: i,
                                    get: function (t) {
                                    ...
                                    transport: function (t) {
                                        return (
                                            ...
                                            f.selectFiles(t).then(function (e) {
                                                for (var n = new FormData(), o = 0; o < e.length; o++) n.append(t.fieldName, e[o], e[o].name);
                                                f.isObject(t.data) &&
                                    ...
                                    selectFiles: function (t) {
                                        return delete (t = u(t)).beforeSend, f.selectFiles(t);
                                    },
                                });
                        t.exports = d;
                    },
                    ...
                    function (t, e) {
                        ...
                        (r.nextTick = function (t) {
                            ...
                            s.push(new h(t, e)), 1 !== s.length || l || u(p);
                        }),
                                    ...
                                    },
                                    {
                                        ...
                                        value: function () {
                                            ...
                                            return new Promise(function (e, n) {
                                                ...
                                                (o.type = "file"),
                                                    t.multiple && o.setAttribute("multiple", "multiple"),
                                                    t.accept && o.setAttribute("accept", t.accept),
                                                    ...
                                                    o.addEventListener(
                                                        ...
                                                        function (t) {
                                                            ...
                                                            e(n), document.body.removeChild(o);
                                                        },
                                                        !1
                                                    ),
                                                    o.click();
                                        ...
                                        ? (function (t) {
                                              ...
                                              Object.keys(t).map(function (a) {
                                                  var u,
                                                      c,
                                                      s = a;
                                                  if ((i && (s = i + "[" + s + "]"), "object" == typeof t[a] && null !== t[a])) u = o(t[a], null, r, s);
                                                  else {
                                                      e && ((c = s), (s = !isNaN(parseFloat(c)) && isFinite(c) ? e + Number(s) : s));
                                                      var l = t[a];
        ...
        function (t, e, n) {
            var o = (function (t) {
                ...
                function b(t, e) {
                    ...
                    return r
                        ? r.done
                            ? ((e[t.resultName] = r.value), (e.next = t.nextLoc), "return" !== e.method && ((e.method = "next"), (e.arg = void 0)), (e.delegate = null), s)
                            : r
                ...
                return (
                    ...
                    (x.prototype = {
                        ...
                        delegateYield: function (t, e, n) {
                            return (this.delegate = { iterator: E(t), resultName: e, nextLoc: n }), "next" === this.method && (this.arg = void 0), s;
                        },
                    }),
                    t
                );
        ...
        function (t, e, n) {
            ...
            function c(t, e) {
                for (var n = {}, o = [], r = 0; r < t.length; r++) {
                    ...
                    -1 !== f ? (a[f].references++, a[f].updater(d)) : a.push({ identifier: l, updater: g(d, e), references: 1 }), o.push(l);
                }
                return o;
            }
            function s(t) {
            ...
            function g(t, e) {
                ...
                if (e.singleton) {
                    var i = m++;
                    (n = h || (h = s(e))), (o = d.bind(null, n, i, !1)), (r = d.bind(null, n, i, !0));
                } else
                    (n = s(e)),
                        (o = p.bind(null, n, e)),
                        (r = function () {
                        ...
                        return this.map(function (e) {
                            var n = (function (t, e) {
                                ...
                                if (e && "function" == typeof btoa) {
                                    var r = ((a = o), (u = btoa(unescape(encodeURIComponent(JSON.stringify(a))))), (c = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(u)), "/*# ".concat(c, " */")),
        ...
        function (t, e, n) {
            ...
            var o = n(3),
                    ...
                    function t(e) {
                        ...
                        c()(this, t),
                            ...
                            (this.nodes = {
                                ...
                                caption: g("div", [this.CSS.input, this.CSS.caption], { contentEditable: !this.readOnly }),
                            }),
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        return (
                                            (e.innerHTML = this.config.buttonContent || "".concat(h.a, " ").concat(this.api.i18n.t("Загрузить картинку"))),
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        var n = this,
                                            o = /\.mp4$/.test(e) ? "VIDEO" : "IMG",
                                            r = { src: e },
                                            i = "load";
                                        "VIDEO" === o && ((r.autoplay = !0), (r.loop = !0), (r.muted = !0), (r.playsinline = !0), (i = "loadeddata")),
                                            (this.nodes.imageEl = g(o, this.CSS.imageEl, r)),
                                ...
                                },
                                {
                                    key: "toggleStatus",
                                    value: function (e) {
                                        for (var n in t.status) Object.prototype.hasOwnProperty.call(t.status, n) && this.nodes.wrapper.classList.toggle("".concat(this.CSS.wrapper, "--").concat(t.status[n]), e === t.status[n]);
                                    },
                                },
                                {
                                    key: "applyTune",
                ...
                g = function (t) {
                    ...
                    Array.isArray(n) ? (e = r.classList).add.apply(e, d()(n)) : n && r.classList.add(n);
                            ...
                            [
                                {
                                    ...
                                    value: function (e) {
                                        var n = this,
                                            o = g("div", this.CSS.wrapper);
                                        return (
                                            (this.buttons = []),
                                            t.tunes.concat(this.actions).forEach(function (t) {
                                                var r = n.api.i18n.t(t.title),
                                                    i = g("div", [n.CSS.buttonBase, n.CSS.button], { innerHTML: t.icon, title: r });
                                                i.addEventListener("click", function () {
                                                    n.tuneClicked(t.name, t.action);
                                                }),
                                ...
                                },
                                {
                                    key: "tuneClicked",
                                    value: function (t, e) {
                                        if ("function" == typeof e && !e(t)) return !1;
                                        var n = this.buttons.find(function (e) {
                                            return e.dataset.tune === t;
                                        });
                                        n.classList.toggle(this.CSS.buttonActive, !n.classList.contains(this.CSS.buttonActive)), this.onChange(t);
                                    },
                                },
                                {
                                    key: "CSS",
                            ...
                            [
                                {
                                    ...
                                    get: function () {
                                        return [
                                            { name: "withBorder", icon: w.a, title: "With border" },
                                            { name: "stretched", icon: x.a, title: "Stretch image" },
                        ...
                        l()(t, [
                            {
                                ...
                                value: function (t) {
                                    ...
                                    (this.config.uploader && "function" == typeof this.config.uploader.uploadByFile
                                        ? L.a.selectFiles({ accept: this.config.types }).then(function (t) {
                                              o(t[0]);
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    this.config.uploader && "function" == typeof this.config.uploader.uploadByUrl
                                        ? F((e = this.config.uploader.uploadByUrl(t))) || console.warn("Custom uploader method uploadByUrl should return a Promise")
                                        : (e = L.a
                                              .post({ url: this.config.endpoints.byUrl, data: Object.assign({ url: t }, this.config.additionalRequestData), type: L.a.contentType.JSON, headers: this.config.additionalRequestHeaders })
                                              .then(function (t) {
                                                  return t.body;
                                              })),
                                        e
                                    ...
                                    if (
                                        ...
                                        a.append(this.config.field, t),
                                            this.config.additionalRequestData &&
                                                ...
                                                Object.entries(this.config.additionalRequestData).forEach(function (t) {
                                                    var e = O()(t, 2),
                                                        n = e[0],
                                                        o = e[1];
                                                    a.append(n, o);
                                                }),
                                            (n = L.a.post({ url: this.config.endpoints.byFile, data: a, type: L.a.contentType.JSON, headers: this.config.additionalRequestHeaders }).then(function (t) {
                                                return t.body;
                                            }));
                                    }
                                    n.then(function (t) {
                ...
                function t(e) {
                    ...
                    c()(this, t),
                        ...
                        (this.config = {
                            ...
                            field: r.field || "image",
                            types: r.types || "image/*",
                            captionPlaceholder: this.api.i18n.t(r.captionPlaceholder || "Подпись"),
                            buttonContent: r.buttonContent || "",
                            uploader: r.uploader || void 0,
                            actions: r.actions || [],
                        }),
                        (this.uploader = new C({
                            config: this.config,
                    ...
                    l()(
                        ...
                        [
                                                ...
                                                function (t) {
                                                    for (;;)
                                                        switch ((t.prev = t.next)) {
                                                            ...
                                                            case 7:
                                                                return (o = t.sent), (t.next = 10), o.blob();
                                                            case 10:
                                                            ...
                                                            case 18:
                                                                return (u = e.detail.file), this.uploadFile(u), t.abrupt("break", 21);
                                                            case 21:
                                                            case "end":
                                                                return t.stop();
                                                        }
                            ...
                            },
                            {
                                key: "uploadingFailed",
                                value: function (t) {
                                    console.log("Image Tool: uploading failed because of", t), this.api.notifier.show({ message: this.api.i18n.t("Couldn’t upload image. Please try another."), style: "error" }), this.ui.hidePreloader();
                                },
                            },
                            {
                                key: "tuneToggled",
