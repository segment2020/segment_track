...
<div class="block-default block-shadow content-margin stocksblock">
	<div class="block-title clearfix">
		...
		<a class="floatright" href="<? echo $arResult['SECTION_PAGE_URL']; ?>?companyId=<? echo $arResult["ITEMS"][0]['PROPERTIES']['companyId']['VALUE']; ?>">
			Все акции<i class="icon-icons_main-10"></i>
		</a>
	</div>
	<div class="row">
<?
...
?>
		<div class="col-sm-4 col-xs-12">
			<div class="tableblockitem line">
				<a class="titleblock" href="<? echo $arItem["DETAIL_PAGE_URL"]; ?>">
					<div class="imgblock floatleft ">
						<img src="<? echo $file['src']; ?>"/>
					</div>
					<div class="textblock ">
						<div class="firmblock">Акции компании <span><? echo $companyName; ?></span></div>
