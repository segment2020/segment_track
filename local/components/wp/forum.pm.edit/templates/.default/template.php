...
<a name="postform"></a>
<div class="forum-header-box blueSiteColor">
...
if (isset($arParams['recipientName']) && !empty($arParams['recipientName']))
	$recipientName = $arParams['recipientName'];
else
	$recipientName = '';
...
<form name="REPLIER" id="REPLIER" action="<?=POST_FORM_ACTION_URI?>" method="POST" onsubmit="return ValidateForm(this);"<?
	...
	<input type="hidden" name="USER_ID" id="USER_ID" value="<? echo $arResult["POST_VALUES"]["USER_ID"]; ?>" readonly="readonly" />
	<?=bitrix_sessid_post()?>
<?
	...
	<div class="forum-reply-fields">
		...
		<div class="forum-reply-field-user">
			<div class="forum-reply-field forum-reply-field-author"><label for="input_USER_ID"><?=GetMessage("F_HEAD_TO")
				...
				<span><input type="text" name="input_USER_ID" id="input_USER_ID" value='<? echo $recipientName; ?>' tabindex="<?=$tabIndex++;?>" <?
					?>value="<?
