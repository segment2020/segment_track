...
if (!$compositeStub)
	if ($arParams['SHOW_NUM_PRODUCTS'] == 'Y' && ($arResult['NUM_PRODUCTS'] > 0 || $arParams['SHOW_EMPTY_VALUES'] == 'Y'))
		$productsNum = $arResult['NUM_PRODUCTS'];
?>


<a href="<? echo $arParams['PATH_TO_BASKET']; ?>" class="list-group-item"><img src="/tpl/images/lkbasket.png">Корзина <span class='newMessageMenuCount'><? echo $productsNum; ?></span></a>
