...
<div class="block-default block-shadow content-margin fliteralphabetblock clearfix show_rus">
	...
	<div class="fliteralphabetshowall floatright">
		<a href="/<? echo $arParams['IBLOCK_TYPE']; ?>/list/"><i class="icon-icons_main-05"></i>Показать все</a>
	</div>
...
?>
							<div class="infotvc">
								<span class="infocomment">Страна: <? echo GetCountryByID($arItem['DISPLAY_PROPERTIES']['country']['VALUE']); ?></span>
							</div>
<?						}
?>
			...
			<div class="newsbfirm">
			<?
			if (IBLOCK_ID_BRANDS == $arParams['IBLOCK_ID'] && !empty($companyName))
				echo 'Собственник бренда ' . $companyName;
			else
				echo 'Собственник лицензии ' . $companyName;
			?>
			</div>
		</div>
