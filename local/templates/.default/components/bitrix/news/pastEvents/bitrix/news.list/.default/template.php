...
<div class="title">Предстоящие события</div>
<?
foreach($arResult["ITEMS"] as $arItem)
{
	if (isset($arItem['PROPERTIES']['dateEnd']['VALUE']) && (strtotime($arItem['PROPERTIES']['dateEnd']['VALUE']) < strtotime('now')) )
		continue;
	//elseif (strtotime($arItem['PROPERTIES']['dateBegin']['VALUE']) >= strtotime('now'))
...
<div class="block-shadow content-margin eventssecblock pastevents">
	<div class="title">Прошедшие события</div>
<?
$counter = 0;
foreach($arResult["ITEMS"] as $arItem)
{
...
<div class="block-shadow content-margin showmoreblock text-center" id='showmoreblock' data='2'>
	<span>+</span>Показать еще 10 событий
</div>
