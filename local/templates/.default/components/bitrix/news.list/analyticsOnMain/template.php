...
foreach($arResult["ITEMS"] as $arItem)
{
	...
	if ($arItem["PREVIEW_PICTURE"]["SRC"])
		$file = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"]["ID"], array('width'=>310, 'height'=>200), BX_RESIZE_IMAGE_PROPORTIONAL, true);
	else
		$file['src'] = '';
?>
	<a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="centerimg" style="background-image: url('<? echo $file['src']; ?>');">
	...
	<div class="block-title thinline clearfix block-title-yellow">
		<a class="bigRed" href="<? echo $arResult['SECTION_PAGE_URL']; ?>"><? echo $arResult['NAME']; ?></a><a class="floatright" href="<? echo $arResult['SECTION_PAGE_URL']; ?>">Смотреть все<i class="icon-icons_main-10"></i></a>
	</div>
<?}?>
