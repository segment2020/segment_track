...
<?								} ?>
					...
					<div class="col-xs-12 hide" id='addMatElem_<? echo $n; ?>'>
						<div class="form-group">
							<label class="control-label mainlabel" for="el_<? echo $n; ?>">Прикрепить материал - введите название публикации</label>
							<input class='form-control autocompliteAdd addMat<? echo $n; ?>' id="" tabindex="-98">
							<input class='hide addMat<? echo $n; ?>Hide' name="<? echo $propertyId . '[' . $n . ']'; ?>" id="hide" tabindex="-98">
						</div>
					</div>
<?				} ?>
			</div>
