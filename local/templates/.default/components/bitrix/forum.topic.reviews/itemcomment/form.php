...
<div class="block-title clearfix">
	...
	<span class="links floatright">
		<? if (!$USER->IsAuthorized()) { ?><a href="#regauth-popup" class="auth-popup-link"><?=GetMessage("SEG_TO_COME_IN")?></a>  /  <a href="#regauth-popup" class="reg-popup-link"><?=GetMessage("SEG_SIGN_UP_NOW")?></a>  /  <? } ?><a href="/rules/"><?=GetMessage("SEG_RULES_OF_DISCUSSION")?></a>
	</span>
</div>
