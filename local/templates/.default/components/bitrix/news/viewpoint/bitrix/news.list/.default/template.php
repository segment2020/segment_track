...
<div class="block-default in block-shadow content-margin corpnewsblock opinionsecblock">
<?
...
?>
	<div class="newsbitem clearfix">
		<a href="<? echo $arItem["DETAIL_PAGE_URL"]; ?>">
			<div class="newsbimg opinionimg floatleft">
				<img src="<? echo $file['src']; ?>">
			</div>
			<div class="newsbtext">
				<div class="newsbfirm">
					<? echo $arItem['PROPERTIES']['name']['VALUE']; ?><? if ($arItem['DISPLAY_PROPERTIES']['companyId']['DISPLAY_VALUE']) { echo ', '.strip_tags($arItem['DISPLAY_PROPERTIES']['companyId']['DISPLAY_VALUE']); } ?>
				</div>
...
?>
</div> <!-- end div class="block-default in block-shadow content-margin corpnewsblock opinionsecblock"> -->
	<div class="paginationblock clearfix">
		<nav aria-label="Page navigation" class="floatleft">
<?
