			...
			<div class="block-default newsblock mainblock block-shadow">
				<div class="news-block-title clearfix">
					...
					<div class="floatright newsselect">
						<a class="newsblockajax" href="#">Показать</a>
...
?>
	...
	false
				...
				<div class="col-xs-12 content-margin">
					<div class="block-default stocksblock mainblock block-shadow">
						<?
						// Акции
						$APPLICATION->IncludeComponent(
	"bitrix:news.list", 
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CHECK_DATES" => "Y",
		"DETAIL_URL" => "/news/companynews/#ELEMENT_CODE#/",
		"AJAX_MODE" => "N",
		"AJAX_OPTION_JUMP" => "N",
		"AJAX_OPTION_STYLE" => "Y",
		"AJAX_OPTION_HISTORY" => "N",
	...
	array(
		...
		"CHECK_DATES" => "Y",
		"DETAIL_URL" => "/news/industrynews/#ELEMENT_CODE#/",
		"AJAX_MODE" => "N",
		"AJAX_OPTION_JUMP" => "N",
		"AJAX_OPTION_STYLE" => "Y",
		"AJAX_OPTION_HISTORY" => "N",
	...
	false
		...
		<div class="col-xs-3 content-margin">
			<div class="block-default eventsblock block-shadow">
<?
