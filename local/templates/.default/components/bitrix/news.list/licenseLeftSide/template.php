...
<div class="tableblockitem clearfix">
	<a href="<? echo $arItem["DETAIL_PAGE_URL"]; ?>">
		...
		<div class="textblock ">
			<div class="firmblock">Лицензия <span><? echo $companyName; ?></span></div>
...
<div class="text-center buttonblock">
	<a class="btn btn-blue" href="<? echo $arResult['SECTION_PAGE_URL']; ?>">Все лицензии<i class="icon-icons_main-10"></i></a>
</div>
