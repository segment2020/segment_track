...
if ('/events/futureevents/' == $currentPage)
{
	$title = 'Предстоящие события';
	$class = 'upcomingevents';
	$activeFuture = 'active';
}
elseif ('/events/pastevents/' == $currentPage)
{
...
<div class="eventstabs clearfix content-margin">
	...
	<div class="tab floatleft">	
		<a href="/events/futureevents/" class='<? echo $activeFuture; ?>'>Предстоящие</a>
	</div>
	<div class="tab floatleft">	
		<a href="/events/pastevents/" class='<? echo $activePast; ?>'>Прошедшие</a>
	</div>
</div>
<div class="block-shadow content-margin eventssecblock <? echo $class; ?>">
