...
<?
// Фотоальбомы.
$APPLICATION->IncludeComponent("bitrix:news.list", "PhotoGalleryInDetail", Array(
	"COMPONENT_TEMPLATE" => "PhotoGalleryInDetail",
		"IBLOCK_TYPE" => "photogallery",	// Тип информационного блока (используется только для проверки)
