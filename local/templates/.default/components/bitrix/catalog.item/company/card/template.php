...
// pre($item);
	...
	$timeStamp = FormatDate("d F Y", MakeTimeStamp($arResult['ITEM']['TIMESTAMP_X']));
	...
	foreach ($item['DISPLAY_PROPERTIES'] as $code => $displayProperty)
	{
		...
		if (('contactPerson' == $displayProperty['CODE']) && (!empty($displayProperty['VALUE'][0])) )
...
?>
	<div class="newsbitem clearfix">
		<div class="newsbimg floatleft">
			<img src="<? echo !empty($fileImg['src'])? $fileImg['src']: EMPTY_IMAGE_PATH; ?>" class="content-margin" />
			<div class="buttonblock">
				<a class="btn minbr red-blue-full arrowbtn" href="<? echo $item['DETAIL_PAGE_URL']; ?>">
		...
		<div class="newsbtext">
			...
			?>
				...
				<div class="companydecritem floatleft">
					...
					<div class="link"><? echo $item['PROPERTIES']['phone']['VALUE']; ?></div>
				</div>
				<div class="companydecritem floatleft">
