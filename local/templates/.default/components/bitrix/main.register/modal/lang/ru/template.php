...
$MESS["REGISTER_EMAIL_WILL_BE_SENT"] = "<h4>Благодарим Вас за регистрацию на портале Сегмент.ру!</h4>
<p>Пожалуйста, зайдите в свой почтовый ящик и активируйте аккаунт прямо сейчас.<br />
Для активации аккаунта достаточно перейти по ссылке внутри письма. <br />
Внимание! Проверьте папку СПАМ, возможно письмо со ссылкой активации попало туда.</p>
";
